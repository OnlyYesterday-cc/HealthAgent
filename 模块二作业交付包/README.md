...
方案2：用AI辅助测试认证、个人信息和血压记录。计划新增20条用例，陆京超、袁立沛各负责10条及相应材料，计划工作量各50%。陆京超的10条测试、M2-D01修复及个人Office材料已完成，待本人复核；袁立沛部分尚未代做。
...
个人Excel、两份Word报告及6页PPT已按模板和既有证据整理，并完成页面核验。本次仅整理材料，没有重跑测试。小组仍需合并另一成员成果，满足至少15条新增用例；关键对话截图、真实人工复核与修改记录、签署及视频尚待完成。个人材料不能直接作为完整小组交付件。PDF载明9月25日展示、当晚23:00提交，最终以课堂通知为准。
